* This folder contains the data Science Specialization Capstone Project which consisted on developing a Natural Language Processing (NPL) Model on Word Prediction.
